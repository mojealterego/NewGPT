...
dependencies {
    ...
    implementation("com.google.dagger:hilt-android:2.57.1"); ksp("com.google.dagger:hilt-compiler:2.57.1"); implementation("androidx.hilt:hilt-navigation-compose:1.2.0")
